...
| [08_subscription_credits_vs_api.md](08_subscription_credits_vs_api.md) | Claude subscription Agent SDK credits vs Console API key; why fynance uses the Console API |
