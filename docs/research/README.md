...
| [08_subscription_credits_vs_api.md](08_subscription_credits_vs_api.md) | Claude subscription Agent SDK credits vs Console API key; decision reversed (see addendum) — fynance now supports a subscription OAuth token alongside the Console API key |
