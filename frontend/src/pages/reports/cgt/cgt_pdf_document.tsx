      ...
      {response.pools.filter((p) => Number.parseFloat(p.current_shares) > 0).length > 0 && (
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text style={{ flex: 1.2, textAlign: "right" }}>Total allowable expenditure</Text>
            <Text style={{ flex: 1, textAlign: "right" }}>Avg cost / share</Text>
          </View>
          {response.pools
            ...
            .map((p) => (
              <View key={p.symbol} style={styles.tableRow}>
                ...
                <Text style={{ flex: 1, textAlign: "right" }}>{p.current_shares}</Text>
                <Text style={{ flex: 1.2, textAlign: "right" }}>
                  {p.total_allowable_expenditure}
                </Text>
                <Text style={{ flex: 1, textAlign: "right" }}>{p.average_cost_per_share}</Text>
              </View>
            ))}
        </Page>
      )}
  ...
  return (
    <View style={styles.disposalBlock} wrap={false}>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.value}>{event.quantity}</Text>
      </View>
      <View style={styles.row}>
